...
### Junior Software Developer — QNT Systemy Informatyczne Sp. z o.o.
**Zabrze, Poland** • 9 months • Commercial
**Systems Development Department** • Enterprise software for government payroll and accounting

- Developed and maintained **accounting, payroll, and financial modules** in **PowerBuilder** and **SQL**
- Wrote **SQL triggers and stored procedures** to enforce business logic and data integrity
- Implemented **module optimizations**, **new features**, and **bug fixes** in existing systems
- Worked with **legacy enterprise codebase**, adapting and refactoring existing code
- **Received regular code reviews** from a senior developer — iterated on feedback and improved code quality
- Created **manual test protocols** — form-based UI verification, screenshots, functional descriptions, and verification steps
- Worked with **anonymized datasets** from public sector clients (government payroll, accounting, financial systems)
- Operated under **NDA** in a regulated environment with strict data protection and confidentiality requirements
- Prepared **daily progress reports** with completion status and descriptions, synced with **Jira**
- Delivered **internal presentations** on completed work to the entire company
- Built domain knowledge in **government payroll, accounting, and financial systems**
- Used **Jira** for task tracking, sprint planning, and agile workflow

**Team context:** started in a **6-person training team** under a senior developer, then transitioned to a **2-person team** alongside senior engineers.
...
<table>
  <tr>
    ...
    <td>
      <table>
        <tr><td><b>FPS</b></td><td>CS:GO, Valorant, PAYDAY 2</td></tr>
        <tr><td><b>MMO</b></td><td>The Division 2</td></tr>
        <tr><td><b>RPG</b></td><td>Witcher 3, Cyberpunk 2077, Fallout 4</td></tr>
        <tr><td><b>Survival</b></td><td>Minecraft, No Man's Sky, Green Hell, Far Cry Primal</td></tr>
        <tr><td><b>Horror</b></td><td>Phasmophobia</td></tr>
      </table>
    </td>
  </tr>
  <tr>
    <td>🏋️ <b>Sports</b></td>
    <td>football, gym, martial arts</td>
  </tr>
  <tr>
    <td>🧘 <b>Lifestyle</b></td>
    <td>holistic health, spiritual growth, travel, positive mindset</td>
  </tr>
  <tr>
    <td>🏆 <b>Achievements</b></td>
    <td>1st place in high school business simulator (computer service)</td>
  </tr>
  <tr>
    <td>🌱 <b>Personal traits</b></td>
    <td>perfectionist, curious, self-developing physically, mentally &amp; spiritually</td>
  </tr>
</table>
